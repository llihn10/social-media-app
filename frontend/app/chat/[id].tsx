...
export default function ActiveChatScreen() {
    ...
    return (
        <SafeAreaView className="flex-1 bg-secondary" edges={['top', 'bottom']}>
            ...
            >
            {/* Header */}
            <View className="flex-row items-center px-3 py-3 border-b border-gray-100 bg-secondary">
            ...
            {/* Input Area */}
                <View className="flex-row items-end px-4 py-3 bg-white border-t border-gray-100 pb-6">
                    <TextInput
